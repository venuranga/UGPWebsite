...
import p1 from '../images/Project/p1.jpg';
import p2 from '../images/Project/p2.jpg';
import p3 from '../images/Project/p3.jpg';
import p4 from '../images/Project/p4.jpg';
import p5 from '../images/Project/p5.jpg';
import p6 from '../images/Project/p6.jpg';
import p7 from '../images/Project/p7.jpg';
import p8 from '../images/Project/p8.jpg';
import p9 from '../images/Project/p9.jpg';
import p10 from '../images/Project/p10.jpg';
import p11 from '../images/Project/p11.jpg';
import p12 from '../images/Project/p12.jpg';
import p13 from '../images/Project/p13.jpg';
import p14 from '../images/Project/p14.jpg';
import p15 from '../images/Project/p15.jpg';


export default function Slider() {
  return (
    <div style={{ marginTop: '800px' }}>
        <div class="row row-cols-1 row-cols-md-4 g-15">
            <div class="col">
                <div class="card">
       ...
       <div style={{ marginTop: '20px' }}></div> {/* Add margin between rows */}
       <div class="row row-cols-1 row-cols-md-4 g-15">
            <div class="col">
                <div class="card">
                    <img src= {p5} class="card-img-top" alt="..."/>
                    <div class="card-body">
                        <h5 class="card-title">Project 05</h5>
                        <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content.</p>
                        <a href="#" class="btn btn-primary">Read More</a>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Project 06</h5>
                        <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content.</p>
                        <a href="#" class="btn btn-primary">Read More</a>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Project 07</h5>
                        <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content.</p>
                        <a href="#" class="btn btn-primary">Read More</a>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Project 08</h5>
                        <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content.</p>
                        <a href="#" class="btn btn-primary">Read More</a>
                    </div>
                </div>
       ...
       <div class="row row-cols-1 row-cols-md-4 g-15">
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Project 09</h5>
                        <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content.</p>
                        <a href="#" class="btn btn-primary">Read More</a>
                    </div>
                </div>
